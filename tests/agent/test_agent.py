...
class AgentTests(unittest.TestCase):
    def test_score_path(self):
        ...
        self.assertTrue(agent.score_path(path_a) < agent.score_path(path_b))
        self.assertTrue(agent.score_path(path_b) < agent.score_path(path_c))
        self.assertTrue(agent.score_path(path_c) < agent.score_path(path_d))
